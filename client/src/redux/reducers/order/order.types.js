...
export const ALL_ORDERS_LIST_REQUEST = "ALL_ORDER_LIST_REQUEST";
export const ALL_ORDERS_LIST_SUCCESS = "ALL_ORDER_LIST_SUCCESS";
export const ALL_ORDERS_LIST_FAILED = "ALL_ORDER_LIST_FAILED";
export const ALL_ORDERS_LIST_RESET = "ALL_ORDER_LIST_RESET";
