...
import { saveShippingAddress, savePaymentMethod } from '../../redux/reducers/cart/cart.actions';
                ...
                <form class="max-w-xl m-4 p-10 bg-white rounded shadow-xl" onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div class="mt-2">
                        ...
                        <label class="inline-flex items-center mt-3">
                            <input type="radio" class="h-5 w-5 text-gray-600" checked
                    ...
                    <div class="mt-4">
                        <button class="px-4 py-1 text-white font-light tracking-wider bg-gray-900 hover:bg-gray-800 rounded" type="submit">Proceed To Payment</button>
                    </div>
                </form>
            </div>
        </>
